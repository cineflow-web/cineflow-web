...
- Tooling: Vite, Webpack, ESLint, Prettier, Jest
- APIs & Data: REST, GraphQL, Fetch, Axios
- Other: Accessibility (a11y), Performance Optimization, Responsive Design

---

## Currently

Working on: A web-first movie discovery experience that helps people find and organize films they love.

---

## Projects & Highlights

- Cineflow — a lightweight, user-first movie discovery and tracking web app (this repo)
- [Project placeholder] — short description of another noteworthy project
